...
Para qualquer modificação neste módulo, baseada no modelo de negócio do seu e-commerce, é possível alterar o código fonte antendendo a  [API da Frete Rápido][9]. E [neste link][8] você encontra a documentação de modificações do **Magento**.
