...
![Mensagem de atenção para backup da loja](http://freterapido.com/dev/imgs/magento_doc/attention_2.png "#FicaDica ;&#41;")
...
![Sessão de dados da origem](https://freterapido.com/dev/imgs/magento_doc/origin_settings.PNG "Dados de origem")
...
![Caminho para contratar o frete](https://freterapido.com/dev/imgs/magento_doc/order.png "Detalhamento do pedido")

* Você será redirecionado para a tela de confirmação do frete. Após conferir as informações, clique no botão **"Submit Shipment"**
![Confirmação da contratação do frete](https://freterapido.com/dev/imgs/magento_doc/confirm_order.PNG "Detalhes do frete")
